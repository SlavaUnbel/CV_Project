...
const mapDispatchToProps = (dispatch: Dispatch) => ({
  ...
  setFilteredTodos: bindActionCreators(portfolioItemsActions.todos.filter, dispatch),
  setStatus: bindActionCreators(portfolioItemsActions.todos.setStatus, dispatch),
});
